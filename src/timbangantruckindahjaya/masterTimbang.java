...
public class masterTimbang extends javax.swing.JFrame {
    ...
    private Object[][] data()
    {
        ...
        if(mod.length>0)
        {
            ...
            for(int i=0 ; i<mod.length ; i++)
            {
                ...
                ret[i][10] = mod[i][26]; //timbang in
                ret[i][11] = mod[i][27]; //timbang out
                ret[i][12] = (mod[i][17].equals("0")?"Belum":"Sudah"); //print
                ret[i][13] = mod[i][25]; //lastupdate
            }
        }
        return ret;
    }
    ...
    private void initComponents() {
        ...
        setTitle("Master Timbangan - PT. Indah Jaya Textile");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/timbangantruckindahjaya/images/app.png"))); // NOI18N
        ...
        jPanel4Layout.setVerticalGroup(
            jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 64, Short.MAX_VALUE)
        );
